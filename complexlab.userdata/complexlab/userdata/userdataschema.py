...
class IEnhancedUserDataSchema(IUserDataSchema):
    ...
    mobile = schema.TextLine(
        ...
        description = _(u'desc_mobile', default = u"IMPORTANTE: per chi volesse richiedere il servizio di Avvisi anche via SMS (Portfolio Silver TOP), è necessario inserire anche il numero di CELLULARE (SENZA codice internazionale)"),
        required = False,
    )
